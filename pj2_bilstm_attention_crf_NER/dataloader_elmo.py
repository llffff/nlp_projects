...
class CoNLLData(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return \
            ...
            torch.LongTensor(self.data[index]['tags']),self.data[index]['str_words']


def collate_fn(insts, args):
    """ Batch preprocess """
    words_batch, chars_batch, tags_batch, _ = list(zip(*insts))
    ...
    return words_batch, chars_batch, tags_batch, sorted_lens,_
