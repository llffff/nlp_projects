...
from utils import update_tag_scheme, prepare_dataset
...
def main():
    ...
    parser.add_argument('--path_embedding', type=str, default='/home/mlsnrs/data/data/lff/data/fudan_nlp/glove/glove.6B.100d.txt',
    ...
    parser.add_argument('--tag_scheme', type=str, default='BIO',
                        help='BIO or BIOES')
